...
class RootRouter < Base
  ...
  <text x="600" y="280" font-size="92" fill="' + (@review.light ? 'black' : 'white') + '" stroke="' + (@review.light ? 'black' : 'white') + '" text-anchor="middle" stroke-width="0.5" >' + @review.title + '</text>
  <line x1="200" y1="310" x2="1000" y2="310" stroke-width="1" stroke="#aaa" />
  <text x="600" y="380" font-size="54" fill="' + (@review.light ? 'black' : 'white') + '" stroke="' + (@review.light ? 'black' : 'white') + '" text-anchor="middle" stroke-width="0.5" >' + @review.music.name + '</text>
  <text x="600" y="520" font-size="64" fill="' + (@review.light ? 'black' : 'white') + '" stroke="' + (@review.light ? 'black' : 'white') + '" text-anchor="middle" stroke-width="0.5" >' + @review.user.name + '</text>
  <line x1="400" y1="535" x2="800" y2="535" stroke-width="1" stroke="#aaa" />
  <text x="600" y="570" font-size="36" fill="' + (@review.light ? 'black' : 'white') + '" stroke="' + (@review.light ? 'black' : 'white') + '" text-anchor="middle" stroke-width="0.5" >@' + @review.user.screen_name + '</text>
